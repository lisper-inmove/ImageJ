...
std::unique_ptr<EditOperation>
EditOperation::merge_with(const EditOperation &other) const {
...
EditOperation::timestamp() const noexcept {
  return timestamp_;
}

void EditOperation::set_timestamp(
