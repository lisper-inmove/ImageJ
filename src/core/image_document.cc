...
const ImageData& ImageDocument::image_data() const noexcept { return image_data_; }
bool ImageDocument::is_valid() const noexcept { return false; }
bool ImageDocument::is_modified() const noexcept { return is_modified_; }
void ImageDocument::set_modified(bool modified) noexcept { is_modified_ = modified; }

const ImageDocument::Metadata& ImageDocument::metadata() const noexcept { return metadata_; }
...
const std::string& ImageDocument::file_path() const noexcept { static std::string empty; return empty; }
const std::string& ImageDocument::file_name() const noexcept { static std::string empty; return empty; }
